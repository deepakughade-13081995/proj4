...
<body>
 ...
 <%@include file="Header.jsp"%>
  ...
  <jsp:useBean id="bean" class="in.co.sunrays.proj4.bean.RoleBean"
    ...
    <center>
        ...
        <h2><font font color="green"><%=ServletUtility.getSuccessMessage(request) %></font></h2>
 ...
 --%>                <%
                ...
                <tr>
                    ...
                    <%if(userBean.getId()==bean1.getId() || bean1.getId() == RoleBean.ADMIN) {%>
        ...
        <table>
        <tr>
        <td><input type="submit" name="operation" value="<%=RoleListCtl.OP_BACK%>"></td></tr>
        </table>
              <%} %>  
