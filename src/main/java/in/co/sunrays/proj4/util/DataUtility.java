...
public static String getDateString(Date date) {
    ...
    * @return
    */
public static Date getDate(int i, int day) {
    return null ;
}
...
public static void main(String[] args) {
    //System.out.println(getDate("08-13-1995"));
	//System.out.println(getCurrentTimestamp());
	//System.out.println(getTimestamp(1123456));
//System.out.println(getDate(4,4));
//System.out.println(getTimestamp(923456789));
//System.out.println(getStringData("mm"));
}
