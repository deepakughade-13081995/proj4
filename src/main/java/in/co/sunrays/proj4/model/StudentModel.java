...
public class StudentModel {
    ...
    public long add(StudentBean bean) throws ApplicationException,
        ...
        bean.setCollageName(collegeBean.getName());
         System.out.println(bean.getCollegeId()+"  "+bean.getCollageName());
       ...
       // System.out.println("email;;;;;;;;;;;;;;;;;;;;;;;;;;  "+duplicateName.getEmail());
        int pk = 0;
        ...
        try {
            ...
            pstmt.setTimestamp(13, bean.getModifiedDatetime());
             ...
             pstmt.executeUpdate();
             System.out.println("pstmt par ho gya");       
    ...
    public void update(StudentBean bean) throws ApplicationException,
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("UPDATE ST_STUDENT SET COLLEGE_ID=?,COLLEGE_NAME=?,FIRST_NAME=?,LAST_NAME=?,DATE_OF_BIRTH=?,MOBILE_NO=?,EMAIL=?,ADDRESS=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
            pstmt.setLong(1, bean.getCollegeId());
            pstmt.setString(2, bean.getCollageName());
...
System.out.println("search start");
        if (bean != null) {
            ...
            if (bean.getCollageName() != null
                    && bean.getCollageName().length() > 0) {
                sql.append(" AND COLLEGE_NAME LIKE '" + bean.getCollageName() + "'");
            }
