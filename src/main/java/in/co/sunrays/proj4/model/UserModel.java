...
public long add(UserBean bean) throws ApplicationException,DuplicateRecordException {
 ...
 .prepareStatement("UPDATE ST_USER SET FIRST_NAME=?,LAST_NAME=?,LOGIN=?,PASSWORD=?,DOB=?,MOBILE_NO=?,ROLE_ID=?,ADDRESS=?,UNSUCCESSFUL_LOGIN=?,GENDER=?,LAST_LOGIN=?,USER_LOCK=?,REGISTERED_IP=?,LAST_LOGIN_IP=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
    ...
    public UserBean authenticate(String login, String password)
        ...
        try {
            ...
            log.error("Database Exception..", e);
            throw new ApplicationException("Exception : Exception in get data");
    ...
    public boolean resetPassword(UserBean bean) throws ApplicationException {
        ...
        String newPassword = String.valueOf(new Date().getTime()).substring(9,
                13);
